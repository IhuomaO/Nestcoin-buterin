...
const TransferToken = () => {
  ...
  return (
    <form id='transfer' className='w-[550px] lg:w-[800px] py-10 rounded-md shadow hover:shadow-xl transition duration-300 bg-white mx-auto flex flex-col border text-center space-y-5' onSubmit={handleSubmit}>
      ...
      <div className='w-full'>
        <Button className='mx-auto' type='submit' form="transfer" value="Submit">Send</Button>
      </div>
    </form>
  )
}
